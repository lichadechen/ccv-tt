...
int mainImage(void)
{
  ...
  IpVec ipts;
  IplImage *img=cvLoadImage("Images/SURF/d4.jpg");
  ...
  cvSaveImage("Images/SURF_RESULT/d4.jpg",img);
  saveSurf("Images/SURF_RESULT/d4.txt",ipts);
...
{
  IplImage *img1, *img2;
  img2 = cvLoadImage("Images/SURF/c1.jpg");
  img1 = cvLoadImage("Images/SURF/c5.jpg");

  IpVec ipts1, ipts2;
//  loadSurf("Images/SURF_RESULT/d1.txt",ipts1);
//  loadSurf("Images/SURF_RESULT/d4.txt",ipts2);
...
//  drawIpoints(img2,ipts2);
  ...
  cvShowImage("First Image", img1);
  cvShowImage("Second Image",img2);
  cvWaitKey(0);
