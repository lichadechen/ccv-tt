...
class Filters {
	...
	//filter values for fiducial marker
	int smoothFiducial;
	int highpassBlurFiducial;
    int highpassNoiseFiducial;
    int	highpassAmpFiducial; 
	...
	virtual void applyCPUFiltersFiducial(CPUImageFilter& img) = 0;
    virtual void draw() = 0;
