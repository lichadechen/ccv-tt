...
void ofxNCoreVision::setupControls()
{
	...
	ofxGuiPanel* propPanel = controls->addPanel(appPtr->propertiesPanel, "Camera Properties", CONTROLX, 0, 12, OFXGUI_PANEL_SPACING);
	...
	ofxGuiPanel* gPanel = controls->addPanel(appPtr->gpuPanel, "GPU Properties", CONTROLX, 95, OFXGUI_PANEL_BORDER, OFXGUI_PANEL_SPACING);
	...
	ofxGuiPanel* oPanel = controls->addPanel(appPtr->optionPanel, "Communication", CONTROLX, 142, OFXGUI_PANEL_BORDER, OFXGUI_PANEL_SPACING);
	...
	ofxGuiPanel* trackingPanel = controls->addPanel(appPtr->optionPanel, "Track", CONTROLX, 234, OFXGUI_PANEL_BORDER, OFXGUI_PANEL_SPACING);
	...
	ofxGuiPanel* cPanel = controls->addPanel(appPtr->calibrationPanel, "Calibration", CONTROLX, 326, OFXGUI_PANEL_BORDER, OFXGUI_PANEL_SPACING);
	...
	ofxGuiPanel* panel2 = controls->addPanel(appPtr->savePanel, "Settings", CONTROLX, 373, OFXGUI_PANEL_BORDER, OFXGUI_PANEL_SPACING);
	...
	//Fiducial Image
	ofxGuiPanel* fiducialPanel = controls->addPanel(appPtr->fiducialPanel, "Fiducial", 686, 487, OFXGUI_PANEL_BORDER, 7);
	fiducialPanel->addSlider(fiducialPanel_amplify,"Amplify",110,13,0.0f,300.0f,0,kofxGui_Display_Int,0);
	fiducialPanel->addSlider(fiducialPanel_smooth,"Smooth",110,13,0.0f,15.0f,0,kofxGui_Display_Int,0);
	fiducialPanel->addSlider(fiducialPanel_blur,"Blur",110,13,0.0f,200.0f,0,kofxGui_Display_Int,0);
	fiducialPanel->addSlider(fiducialPanel_noise,"Noise",110,13,0.0f,30.0f,0,kofxGui_Display_Int,0);
	fiducialPanel->mObjWidth = 127;
	fiducialPanel->mObjHeight = 180;
...
// 			break;
		...
		//Fiducial Values
		case fiducialPanel_amplify:
			if( length == sizeof(float))
				filter->highpassAmpFiducial = *(float*)data;
			break;
		case fiducialPanel_blur:
			if( length == sizeof(float))
				filter->highpassBlurFiducial = *(float *)data;
			break;
		case fiducialPanel_noise:
			if( length == sizeof(float))
				filter->highpassNoiseFiducial = *(float*)data;
			break;
		case fiducialPanel_smooth:
			if( length == sizeof(float))
				filter->smoothFiducial = *(float*)data;
			break;
